...
export const VARIANT_MODELS = [
  { id: "gemini-2.5-flash", name: "Gemini 2.5 Flash (Mặc định - Ổn định)" },
  { id: "gemini-2.5-flash-lite", name: "Gemini 2.5 Flash-Lite (Siêu nhanh)" },
  { id: "gemini-2.5-pro", name: "Gemini 2.5 Pro (Cao cấp)" },
  { id: "gemini-1.5-flash", name: "Gemini 1.5 Flash (Dự phòng)" },
  { id: "gemini-1.5-pro", name: "Gemini 1.5 Pro (Dự phòng)" },
];
